...
namespace RemliCMS.Controllers
{
    ...
    {
        public AccountController(IRouteService routeService) : base(routeService)
        {
        }
        ...
        {
            ViewBag.Title = "Site Admin Login";
        ...
        {
            ViewBag.Title = "Site Admin Registeration";
            return View();
        }
